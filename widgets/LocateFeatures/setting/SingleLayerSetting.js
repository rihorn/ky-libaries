...
define([
  ...
  'dojo/text!./SingleLayerSetting.html',
  'dojo/_base/lang',
  'dojo/_base/array',
  'dojo/_base/html',
  'dojo/_base/query',
...
function(declare, _WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin, template, lang,
  ...
  esriRequest, esriSymbolJsonUtils) {
  return declare([_WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin, Evented], {
    baseClass: 'jimu-widget-single-layer-setting',
    ...
    getConfig: function () {
      ...
      if(!this.layerNameTextBox.validate()){
        this.showValidationErrorTip(this.layerNameTextBox);
        return null;
      }
      config.name = this.layerNameTextBox.get('value');
    ...
    _onLayerNameChanged: function(){
      this.emit('name-change',this.layerNameTextBox.get('value'));
    },

    _clear: function(){
      this.urlTextBox.set('value','');
      this._layerDefinition = null;
      this.layerNameTextBox.set('value','');
      this.filter.reset();
      this.tab.showShelter();
    ...
    _resetByNewLayerDefinition: function(layerInfo, /* optional */ queryName){
      ...
      this.layerNameTextBox.set('value', queryName || layerInfo.name);
      this.tab.hideShelter();
    ...
    _resetByConfig:function(cfg, layerInfo){
      ...
      this.layerNameTextBox.set('value',config.name||'');
