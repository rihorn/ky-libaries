 ...
 */
export declare function createProcessFactoryWith(callbackDecorators: ProcessCallbackDecorator[]): <S, P extends object>(id: string, commands: (Command<S, P> | Command<S, P>[])[], callback?: ProcessCallback<S> | undefined) => Process<S, P>;
/**
