(function (factory) {
    ...
    var WebAnimations = /** @class */ (function (_super) {
        ...
        WebAnimations.prototype._createPlayer = function (node, properties) {
            ...
            var keyframeEffect = new global_1.default.KeyframeEffect(node, fx, timing);
            return new global_1.default.Animation(keyframeEffect, global_1.default.document.timeline);
        };
