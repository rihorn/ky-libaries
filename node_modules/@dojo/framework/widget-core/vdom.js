(function (factory) {
    ...
    function renderer(renderer) {
        ...
        function renderedToWrapper(rendered, parent, currentParent) {
            ...
            var currentParentLength = isVNodeWrapper(currentParent) && (currentParent.childrenWrappers || []).length > 1;
            var requiresInsertBefore = ((parent.requiresInsertBefore || parent.hasPreviousSiblings !== false) && hasParentWNode) ||
                currentParentLength;
            var previousItem;
            for (var i = 0; i < rendered.length; i++) {
                ...
                var wrapper = {
                    ...
                    requiresInsertBefore: requiresInsertBefore,
        ...
        function mount(mountOptions) {
            ...
            if (d_1.isVNode(renderResult)) {
                renderResult = d_1.w(wrapVNodes(renderResult), {});
            }
            var nextWrapper = {
                node: renderResult,
                depth: 1
            };
            _parentWrapperMap.set(nextWrapper, { depth: 0, domNode: domNode, node: d_1.v('fake') });
            _processQueue.push({
                current: [],
                next: [nextWrapper],
        ...
        function _runInvalidationQueue() {
            ...
            _invalidationQueue = [];
            invalidationQueue.sort(function (a, b) { return b.depth - a.depth; });
            var item;
        ...
        function _createWidget(_a) {
            ...
            instanceData.invalidate = function () {
                ...
                if (!instanceData.rendering && _instanceToWrapperMap.has(instance)) {
                    _invalidationQueue.push({ instance: instance, depth: next.depth });
                    _schedule();
                }
            };
